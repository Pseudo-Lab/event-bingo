...
export const PLATFORM_PRIVACY_POLICY_MARKDOWN = `# Bingo Networking 개인정보처리방침
...
Bingo Networking 개인정보 보호 관련 문의, 열람청구, 정정·삭제 요구는 **devfactory.ops@gmail.com**로 할 수 있으며, 법령에서 정한 사유가 없는 한 지체 없이 처리합니다.
