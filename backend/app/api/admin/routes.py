...
async def create_admin_event(
    ...
    try:
        ...
        event = await Event.create(
            ...
            restrict_before_start=payload.restrict_before_start,
            english_support_enabled=payload.english_support_enabled,
            keywords=normalize_event_keywords(
                payload.keywords,
                payload.board_size,
                english_support_enabled=payload.english_support_enabled,
                keyword_translations=payload.keyword_translations,
            ),
